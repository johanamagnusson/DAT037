...
/**
 * The MinComparator class compares two Bid objects and returns a 1 if the
 * second one is lesser than the first. If they are equal it returns 0 and -1 if
 * the second one is greater than the first.
 *
...
public class MinComparator implements Comparator<Bid> {
     ...
     * @return 1 if the second object is lesser than the first, -1 if it is greater
